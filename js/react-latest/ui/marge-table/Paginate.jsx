    ...
    return (
        <div className={styles.sp1_table__pagination}>
            <div className={styles.table_pagiantion__dd}>
                ...
                <select
                    value={perPageRow}
                    onChange={(e) => onPageRowChange(Number(e.target.value))}
                >
            ...
            <div className={styles.table_pagiantion__info}>
                ...
                <div className={styles.table_pagiantion__button_group}>
                    <Button
                        pageIndex={pageIndex}
                        onClick={() =>
                            onPageChange(pageIndex > 1 ? pageIndex - 1 : 1)
                        }
                    >
                        Previous
                    </Button>
                    ...
                    <Button
                        pageIndex={pageIndex}
                        onClick={() =>
                            onPageChange(pageIndex < _total ? pageIndex + 1 : 1)
                        }
                    >
                        Next
                    </Button>
